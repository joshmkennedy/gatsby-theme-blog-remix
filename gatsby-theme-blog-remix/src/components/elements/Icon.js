...
/**
 * this component returns an svg icon
 * requires the prop name
 * based on name will return a svg icon
 */
      ...
      return (
        <>
          <svg
            ...
            fill={props.color}
          >
            <rect x='164.58' width='659.42' height='100' />
            <rect y='222.25' width='824' height='100' />
            <rect y='430' width='824' height='100' />
          </svg>
        </>
      );
    default:
